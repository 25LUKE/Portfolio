...
import assert from '../assert/image.png'

export default function Intro() {
    const { ref } = useSectionHooks("Home", 0.5)
  ...
  return (
    <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        {/* to get rid of the error {I'm} in the peregaph we'll go to our eslintrc an reset it manualy */}
        <motion.h1 className='mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-axl'
            initial={{ opacity: 0, y: 100}}
            animate={{ opacity: 1, y: 0 }}
        >
        <span className="font-bold">Hello, I'm Eric Luke.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">3 years</span> of training experience. I enjoy
        ...
        >
            ...
            <a className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full
                ...
                cursor-pointer borderBlack dark:bg-white/10'
                 href='/Eric.L. Akabero CV.pdf' download={true}>
            ...
            <a className='bg-white p-4 text-gray-700 flex items-center text-[1.35rem] gap-2 rounded-full
                focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition 
                cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60'
